/*
** Lua binding: 
** Generated automatically by tolua++-1.0.92 on Sun Jul  9 13:41:02 2017.
*/
...
#ifndef TOLUA_DISABLE_tolua__AudioSource_new00
static int tolua__AudioSource_new00(lua_State* tolua_S)
{
...
#ifndef TOLUA_DISABLE_tolua__AudioSource_new00_local
static int tolua__AudioSource_new00_local(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua__AudioSource_delete00
static int tolua__AudioSource_delete00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua__AudioSource_LoadAudio00
static int tolua__AudioSource_LoadAudio00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua__AudioSource_Play00
static int tolua__AudioSource_Play00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
#ifndef TOLUA_DISABLE_tolua__AudioSource_Loop00
static int tolua__AudioSource_Loop00(lua_State* tolua_S)
{
#ifndef TOLUA_RELEASE
 tolua_Error tolua_err;
 if (
...
TOLUA_API int tolua__open (lua_State* tolua_S)
{
 ...
 tolua_beginmodule(tolua_S,NULL);
  ...
  tolua_beginmodule(tolua_S,"AudioSource");
   tolua_function(tolua_S,"new",tolua__AudioSource_new00);
   tolua_function(tolua_S,"new_local",tolua__AudioSource_new00_local);
   tolua_function(tolua_S,".call",tolua__AudioSource_new00_local);
   tolua_function(tolua_S,"delete",tolua__AudioSource_delete00);
   tolua_function(tolua_S,"LoadAudio",tolua__AudioSource_LoadAudio00);
   tolua_function(tolua_S,"Play",tolua__AudioSource_Play00);
   tolua_function(tolua_S,"Loop",tolua__AudioSource_Loop00);
