...
void Camera::Update()
{
	...
	mMatrix_View = glm::lookAt(glm::vec3(mTransform->GetLocalPosition().mX, mTransform->GetLocalPosition().mY, mTransform->GetLocalPosition().mZ + Application::MouseWheel / 120.0), glm::vec3(0, 0, 0), glm::vec3(0, 1, 0));
